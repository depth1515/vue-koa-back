...
async function send (sendInfo) {
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: '1587688408@qq.com', // generated ethereal user
      pass: 'yidqyqtdcqxogbhc', // generated ethereal password
    },
  });
  ...
  let url = 'http://www.localhost.mmm'

  // send mail with defined transport object
  let info = await transporter.sendMail({
    from: '"verify email" <1587688408@qq.com>', // sender address
